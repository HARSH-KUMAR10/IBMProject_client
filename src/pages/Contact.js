        ...
        <div>
            ...
            <div className="row border-top">
                <div className="col-5 px-4 py-2 border-end">
                    ...
                    <div className="px-2 pt-1">For any queries or suggestions contact us.</div>
                    <div className="px-2 pb-1">Please enter your email correctly. So, we can get back to you.</div>
                    <div className="py-2">
