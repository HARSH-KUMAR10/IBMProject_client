    ...
    fetch("/contact", {
      ...
      .then((response) => {
        if (response.statusCode === 106) {
          setEmail("");
          setComment("");
          alert("Thank you for submiting our contact form, we will get in touch with you soon.")
        } else {
          ...
          <div style={{ fontSize: 15 }}>
            ...
            <div className="py-2">
              ...
              <div className="py-3 px-2">
                <button disabled={sendBtn} type="submit" className="btn btn-outline-success">Send</button>
              </div>
            </div>
            </form>
          </div>
